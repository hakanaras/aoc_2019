...
Qty requiredOre(const Reaction[Chemical] reactions, Qty fuelQty) {
	...
	auto qty = requiredOreQty(ChemicalQty("FUEL", fuelQty));
...
void main() {
	...
	auto fuelQty = 2_270_000;
	auto oreRequirement = long.max;
	while (oreRequirement > 1_000_000_000_000) {
		oreRequirement = requiredOre(reactions, --fuelQty);
		writeln(fuelQty, " -> ", oreRequirement);
	}
}
